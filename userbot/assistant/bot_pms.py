    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"Hey! 👤{mention},\
                        ...
                        \n\nPowered by [Zeus Bots](https://t.me/ZeusBotsNetwork)"
        buttons = [
            (
                Button.url("Repo", "https://github.com/Sathishzus/ZeusUserBot"),
                Button.url(
                    "Deploy",
                    "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FSathishzus%2FZeusUserBot&template=https%3A%2F%2Fgithub.com%2FSathishzus%2FZeusUserBot",
                ),
            )
        ]
    else:
